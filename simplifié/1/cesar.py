...
def main():
    ...
    shift = 3 # Modifier le 0 en le shift approprié
    
    """Lire le message chiffré depuis le fichier"""
    ciphertext = read_file('message.txt') # Créer le fichier contenant le texte chiffré et donner le chemin vers ce fichier à read_file() 
